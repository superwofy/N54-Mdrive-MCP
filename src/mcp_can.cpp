...
*********************************************************************************************************/
INT8U MCP_CAN::mcp2515_configRate()            
{
...
void MCP_CAN::mcp2515_initCANBuffers(void)
{
    ...
    mcp2515_write_mf(MCP_RXM0SIDH, ulMask);			/*Set both masks to 0           */
    mcp2515_write_mf(MCP_RXM1SIDH, ulMask);			/*Mask register ignores ext bit */
    
                                                                        /* Set all filters to 0         */
    mcp2515_write_mf(MCP_RXF0SIDH, ulFilt);			/* RXB0: extended               */
    mcp2515_write_mf(MCP_RXF1SIDH, ulFilt);			/* RXB1: standard               */
    mcp2515_write_mf(MCP_RXF2SIDH, ulFilt);			/* RXB2: extended               */
    mcp2515_write_mf(MCP_RXF3SIDH, ulFilt);			/* RXB3: standard               */
    mcp2515_write_mf(MCP_RXF4SIDH, ulFilt);
    mcp2515_write_mf(MCP_RXF5SIDH, ulFilt);
...
*********************************************************************************************************/
void MCP_CAN::mcp2515_write_id( const INT8U mcp_addr, const INT32U id )
{
    uint16_t canid;
    INT8U tbufdata[4];
...
*********************************************************************************************************/
void MCP_CAN::mcp2515_write_mf( const INT8U mcp_addr, const INT32U id )
{
    uint16_t canid;
    INT8U tbufdata[4];
...
*********************************************************************************************************/
void MCP_CAN::mcp2515_read_id( const INT8U mcp_addr, INT32U* id )
{
    INT8U tbufdata[4];
...
void MCP_CAN::mcp2515_write_canMsg( const INT8U buffer_sidh_addr)
{
    ...
    mcp2515_write_id(mcp_addr, m_nID );                      /* write CAN id                 */
...
void MCP_CAN::mcp2515_read_canMsg( const INT8U buffer_sidh_addr)        /* read can msg                 */
{
    ...
    mcp2515_read_id( mcp_addr,&m_nID );
...
INT8U MCP_CAN::init_Mask(INT8U num, INT32U ulData)
{
  ...
  return res;
    ...
    if (num == 0){
        mcp2515_write_mf(MCP_RXM0SIDH, ulData);

    }
    else if(num == 1){
        mcp2515_write_mf(MCP_RXM1SIDH, ulData);
    }
...
INT8U MCP_CAN::init_Filt(INT8U num, INT32U ulData)
{
    ...
    {
        case 0:
        mcp2515_write_mf(MCP_RXF0SIDH, ulData);
        break;

        case 1:
        mcp2515_write_mf(MCP_RXF1SIDH, ulData);
        break;

        case 2:
        mcp2515_write_mf(MCP_RXF2SIDH, ulData);
        break;

        case 3:
        mcp2515_write_mf(MCP_RXF3SIDH, ulData);
        break;

        case 4:
        mcp2515_write_mf(MCP_RXF4SIDH, ulData);
        break;

        case 5:
        mcp2515_write_mf(MCP_RXF5SIDH, ulData);
        break;
...
*********************************************************************************************************/
INT8U MCP_CAN::setMsg(INT32U id, INT8U rtr, INT8U len, INT8U *pData)
{
    int i = 0;
    m_nID     = id;
    m_nRtr    = rtr;
...
INT8U MCP_CAN::sendMsgBuf(INT32U id, INT8U len, INT8U *buf)
{
    ...
    setMsg(id, rtr, len, buf);		//hardcoded for standard messages.
    return sendMsg();
}
...
*********************************************************************************************************/
INT8U MCP_CAN::readMsgBuf(INT32U *id, INT8U buf[])
{
