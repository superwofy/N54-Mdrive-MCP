 ...
 *********************************************************************************************************/
    ...
    INT8U setMsg(INT32U id, INT8U rtr, INT8U len, INT8U *pData);        // Set message
    INT8U readMsg();                                                    // Read message
    INT8U sendMsg();                                                    // Send message

public:
    MCP_CAN(INT8U _CS);
    INT8U begin();       // Initialize controller parameters
    ...
    INT8U readMsgBuf(INT32U *id, INT8U *buf);               			// Read message from receive buffer
